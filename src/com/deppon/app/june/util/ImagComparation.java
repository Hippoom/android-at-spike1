...
public class ImagComparation {
	...
	public static boolean compare (String path1, String path2) throws FileNotFoundException {  
        ...
        res = compare(bitmap1,bitmap2);  
      
        return res;  
              
    }  
	public static boolean compare (String path1, String path2,double percent) throws FileNotFoundException {  
        FileInputStream fis1 = new FileInputStream(path1);  
        Bitmap bitmap1  = BitmapFactory.decodeStream(fis1);  
        ...
        return compare(bitmap1,bitmap2,percent);  
              
    }  
      
    public static boolean compare (Bitmap bitmap1, Bitmap bitmap2, double percent) {  
    ...
    public static boolean compare (Bitmap bmp1, Bitmap bmp2) throws FileNotFoundException {  
        boolean res = false;  
